...
type ProjectTimesContextType = {
    ...
    setProjectTimes: (projectTimes: ProjectTimeDto[]) => void;
}

const ProjectTimesContext = createContext<ProjectTimesContextType | undefined>(undefined);

export const useProjectTimes = () => {
    const context = useContext(ProjectTimesContext);
    if (!context) throw new Error("useProjectTimes must be used within ProjectTimesProvider");
    return context;
} 
