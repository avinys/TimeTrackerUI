          ...
          {loadingTop ? (
            ...
            <>
              <h2 className={styles.selectTitle}>
                {currentProject ? `Selected project: ${currentProject?.name}` : 'Select a project'}
              </h2>
              <select
              ...
              <div className={styles.checkboxInput}>
                ...
                />
                <label htmlFor="show-cost">Would you like to input your hourly cost?</label>
              </div>
              {showCostInput && (
                <input
                  className={styles.inputElement}
                ...
                <div className={styles.summaryGrid}>
                  ...
                  <div className={styles.vizSwitch}>
                    <div className={styles.toggleRow}>
                      <button
                        className={clsx('btn', 'btnIcon', 'btnOutline', styles.toggleBtn)}
                        onClick={() => setShowGraph((p) => !p)}
                        aria-label={showGraph ? 'Show table' : 'Show graph'}
                        title={showGraph ? 'Toggle table view' : 'Toggle graph view'}
                      >
